...
export default {
			...
			coupons: [
				{
					...
					url: 'https://s.click.ele.me/rUKsgou',
					type: 1,
					tabId: 1,
					isUse: 1,
					minapp: {
						appid: 'wxece3a9a4c82f58c9',
						path: 'pages/sharePid/web/index?scene=https://s.click.ele.me/rUKsgou'
					}
				},
				{
					name: '饿了么果蔬',
					...
					url:'https://s.click.ele.me/8S3Nlou',
					type: 1,
					tabId: 1,
					isUse: 1,
					minapp: {
						appid: 'wxece3a9a4c82f58c9',
						path: 'pages/sharePid/web/index?scene=https://s.click.ele.me/8S3Nlou'
					}
				},
				{
					name: '美团外卖红包',
	...
	methods: {
		...
		toCoupon(i){
			...
			if(this.coupons[i].isUse == 0 || this.couponList[i].isUse == 0){
				// console.log('敬请期待项：' + this.coupons[i].isUse);
				uni.showToast({
					title: '敬请期待',
					icon:'none',
					duration: 2000
